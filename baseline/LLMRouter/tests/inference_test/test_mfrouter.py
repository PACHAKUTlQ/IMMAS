...
def main():
    ...
    )  # e.g. /data/taofeng2/LLMRouter
    default_yaml = os.path.join(
        project_root, "configs", "model_config_test", "mfrouter.yaml"
    )
    ...
    result_single = router.route_single(
        {"query": "Explain reinforcement learning briefly."}
    )
