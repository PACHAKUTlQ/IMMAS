...
def length_based_metric(
    prediction: str, ground_truth: str, min_length: int = 5, **kwargs
) -> float:
    """
...
def contains_keywords_metric(
    prediction: str, ground_truth: str, keywords: list = None, **kwargs
) -> float:
    """
...
def similarity_metric(
    prediction: str, ground_truth: str, threshold: float = 0.8, **kwargs
) -> float:
